...
<body>
	...
	<div class="container text-left " style='margin-left:30%'>
		<h1 style="color: red">Thêm  Phòng Ban</h1>

		<form action="<%=request.getContextPath()%>/ThemphongbanController" method="post">
		<label>Mã phòng ban:</label>
		<input type="text" name="ma" value=""> <br> <br>
		<label>Mô tả:</label>
		<input type="text" name="mota" value=""> <br> <br>
		<label>Thời gian:</label>
		<input type="text" name="thoigian" value=""> <br> <br>
		<br>
