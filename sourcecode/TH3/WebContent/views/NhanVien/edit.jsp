...
<body>
	...
	<div class="container text-left " style='margin-left:30%'>
		<h1 style="color: red">Sửa Nhân Viên Phòng Ban</h1>
	<%
	String ma="";
	String ten="";
	String diachi="";
	...
	if(request.getAttribute("nv")!=null){
		...
		mapb=nv.getIdpb();
	%>
		<form action="<%=request.getContextPath()%>/SuanhanvienController?id=<%=ma %>" method="post">
		<label>Mã nhân viên:</label>
		<input type="text" name="ma" value="<%=ma%>"> <br> <br>
		<label>Họ tên:</label>
		<input type="text" name="ten" value="<%=ten%>"> <br> <br>
		<label>Địa chỉ:</label>
		<input type="text" name="diachi" value="<%=diachi%>"> <br> <br>
		<label>Mã phòng ban:</label>
		<input type="text" name="mapb" value="<%=mapb%>">  <br> <br>
